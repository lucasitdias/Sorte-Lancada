"use strict";
/* build-hook-start *//*00001*/try { require('/home/lucas/.vscode/extensions/wallabyjs.console-ninja-1.0.493/out/buildHook/index.js').default({tool: 'next.js', checkSum: '209a43db44c5b63eff780fCFUaAUpRDgwBAARQBV0ABQINVgUP', mode: 'build.native', condition: process.env.TURBOPACK === "1" || process.env.TURBOPACK === "auto"}); } catch(cjsError) { try { import('file:///home/lucas/.vscode/extensions/wallabyjs.console-ninja-1.0.493/out/buildHook/index.js').then(m => m.default.default({tool: 'next.js', checkSum: '209a43db44c5b63eff780fCFUaAUpRDgwBAARQBV0ABQINVgUP', mode: 'build.native', condition: process.env.TURBOPACK === "1" || process.env.TURBOPACK === "auto"})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */
